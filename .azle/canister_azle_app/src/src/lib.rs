...
struct StableBTreeMap0ValueType(SmartHomeTask);
impl CdkActTryIntoVmValue<&mut boa_engine::Context<'_>, boa_engine::JsValue>
...
#[ic_cdk_macros::query(name = "getInitialSmartHomeTasks")]
#[candid::candid_method(query, rename = "getInitialSmartHomeTasks")]
async fn _cdk_user_defined_getInitialSmartHomeTasks() -> (_AzleResult<
    Vec<SmartHomeTask>,
    String,
>) {
    unwrap_or_trap(|| {
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "getInitialSmartHomeTasks".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("getInitialSmartHomeTasks", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "getInitialSmartHomeTasks"),
                    ))?;
...
#[ic_cdk_macros::query(name = "loadMoreSmartHomeTasks")]
#[candid::candid_method(query, rename = "loadMoreSmartHomeTasks")]
async fn _cdk_user_defined_loadMoreSmartHomeTasks(
    _cdk_user_defined_offset: _CdkFloat64,
    _cdk_user_defined_limit: _CdkFloat64,
) -> (_AzleResult<Vec<SmartHomeTask>, String>) {
    unwrap_or_trap(|| {
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                let mut boa_context = boa_context_ref_cell.borrow_mut();
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "loadMoreSmartHomeTasks".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("loadMoreSmartHomeTasks", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "loadMoreSmartHomeTasks"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::query(name = "getSmartHomeTask")]
#[candid::candid_method(query, rename = "getSmartHomeTask")]
async fn _cdk_user_defined_getSmartHomeTask(
    _cdk_user_defined_id: String,
) -> (_AzleResult<SmartHomeTask, String>) {
    unwrap_or_trap(|| {
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                let mut boa_context = boa_context_ref_cell.borrow_mut();
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "getSmartHomeTask".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("getSmartHomeTask", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "getSmartHomeTask"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::query(name = "getSmartHomeTasksByTags")]
#[candid::candid_method(query, rename = "getSmartHomeTasksByTags")]
async fn _cdk_user_defined_getSmartHomeTasksByTags(
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "getSmartHomeTasksByTags".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("getSmartHomeTasksByTags", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "getSmartHomeTasksByTags"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::query(name = "searchSmartHomeTasks")]
#[candid::candid_method(query, rename = "searchSmartHomeTasks")]
async fn _cdk_user_defined_searchSmartHomeTasks(
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "searchSmartHomeTasks".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("searchSmartHomeTasks", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "searchSmartHomeTasks"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::query(name = "getSmartHomeTasksByStatus")]
#[candid::candid_method(query, rename = "getSmartHomeTasksByStatus")]
async fn _cdk_user_defined_getSmartHomeTasksByStatus(
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "getSmartHomeTasksByStatus".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("getSmartHomeTasksByStatus", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "getSmartHomeTasksByStatus"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::query(name = "getSmartHomeTasksByCreator")]
#[candid::candid_method(query, rename = "getSmartHomeTasksByCreator")]
async fn _cdk_user_defined_getSmartHomeTasksByCreator(
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "getSmartHomeTasksByCreator".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("getSmartHomeTasksByCreator", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "getSmartHomeTasksByCreator"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::query(name = "getOverdueSmartHomeTasks")]
#[candid::candid_method(query, rename = "getOverdueSmartHomeTasks")]
async fn _cdk_user_defined_getOverdueSmartHomeTasks() -> (_AzleResult<
    Vec<SmartHomeTask>,
    String,
>) {
    unwrap_or_trap(|| {
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "getOverdueSmartHomeTasks".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("getOverdueSmartHomeTasks", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "getOverdueSmartHomeTasks"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(&boa_engine::JsValue::Null, &[], &mut boa_context)?;
                let final_return_value = async_await_result_handler(
...
#[ic_cdk_macros::update(name = "addSmartHomeTask")]
#[candid::candid_method(update, rename = "addSmartHomeTask")]
async fn _cdk_user_defined_addSmartHomeTask(
    _cdk_user_defined_payload: SmartHomeTaskPayload,
) -> (_AzleResult<SmartHomeTask, String>) {
    unwrap_or_trap(|| {
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "addSmartHomeTask".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("addSmartHomeTask", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "addSmartHomeTask"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::update(name = "addSmartHomeTaskTags")]
#[candid::candid_method(update, rename = "addSmartHomeTaskTags")]
async fn _cdk_user_defined_addSmartHomeTaskTags(
    _cdk_user_defined_id: String,
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "addSmartHomeTaskTags".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("addSmartHomeTaskTags", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "addSmartHomeTaskTags"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::update(name = "updateSmartHomeTask")]
#[candid::candid_method(update, rename = "updateSmartHomeTask")]
async fn _cdk_user_defined_updateSmartHomeTask(
    _cdk_user_defined_id: String,
    _cdk_user_defined_payload: SmartHomeTaskPayload,
) -> (_AzleResult<SmartHomeTask, String>) {
    unwrap_or_trap(|| {
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "updateSmartHomeTask".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("updateSmartHomeTask", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "updateSmartHomeTask"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::update(name = "deleteSmartHomeTask")]
#[candid::candid_method(update, rename = "deleteSmartHomeTask")]
async fn _cdk_user_defined_deleteSmartHomeTask(
    _cdk_user_defined_id: String,
) -> (_AzleResult<SmartHomeTask, String>) {
    unwrap_or_trap(|| {
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "deleteSmartHomeTask".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("deleteSmartHomeTask", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "deleteSmartHomeTask"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::update(name = "assignDeviceToSmartHomeTask")]
#[candid::candid_method(update, rename = "assignDeviceToSmartHomeTask")]
async fn _cdk_user_defined_assignDeviceToSmartHomeTask(
    _cdk_user_defined_taskId: String,
    _cdk_user_defined_device: Device,
) -> (_AzleResult<SmartHomeTask, String>) {
    unwrap_or_trap(|| {
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "assignDeviceToSmartHomeTask".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("assignDeviceToSmartHomeTask", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "assignDeviceToSmartHomeTask"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
                        &[
                            _cdk_user_defined_taskId
                                .try_into_vm_value(&mut boa_context)?,
...
#[ic_cdk_macros::update(name = "changeSmartHomeTaskStatus")]
#[candid::candid_method(update, rename = "changeSmartHomeTaskStatus")]
async fn _cdk_user_defined_changeSmartHomeTaskStatus(
    _cdk_user_defined_id: String,
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "changeSmartHomeTaskStatus".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("changeSmartHomeTaskStatus", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "changeSmartHomeTaskStatus"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::update(name = "setSmartHomeTaskPriority")]
#[candid::candid_method(update, rename = "setSmartHomeTaskPriority")]
async fn _cdk_user_defined_setSmartHomeTaskPriority(
    _cdk_user_defined_id: String,
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "setSmartHomeTaskPriority".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("setSmartHomeTaskPriority", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "setSmartHomeTaskPriority"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
#[ic_cdk_macros::update(name = "sendSmartHomeTaskDueDateReminder")]
#[candid::candid_method(update, rename = "sendSmartHomeTaskDueDateReminder")]
async fn _cdk_user_defined_sendSmartHomeTaskDueDateReminder(
    _cdk_user_defined_id: String,
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "sendSmartHomeTaskDueDateReminder"
                            .to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                ...
                let function_js_value = exports_js_object
                    .get("sendSmartHomeTaskDueDateReminder", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "sendSmartHomeTaskDueDateReminder"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
                ...
                let final_return_value = async_await_result_handler(
                    ...
                    &boa_return_value,
                    &uuid,
                    "sendSmartHomeTaskDueDateReminder",
                    false,
                )?;
                Ok(final_return_value.try_from_vm_value(&mut *boa_context)?)
            })
...
#[ic_cdk_macros::update(name = "addSmartHomeTaskComment")]
#[candid::candid_method(update, rename = "addSmartHomeTaskComment")]
async fn _cdk_user_defined_addSmartHomeTaskComment(
    _cdk_user_defined_id: String,
        ...
        BOA_CONTEXT_REF_CELL
            .with(|boa_context_ref_cell| {
                ...
                METHOD_NAME_REF_CELL
                    .with(|method_name_ref_cell| {
                        let mut method_name_mut = method_name_ref_cell.borrow_mut();
                        *method_name_mut = "addSmartHomeTaskComment".to_string();
                    });
                MANUAL_REF_CELL
                    .with(|manual_ref_cell| {
                        let mut manual_mut = manual_ref_cell.borrow_mut();
                ...
                let function_js_value = exports_js_object
                    .get("addSmartHomeTaskComment", &mut boa_context)?;
                let function_js_object = function_js_value
                    .as_object()
                    .ok_or_else(|| RuntimeError::ReferenceError(
                        format!("{} is not defined", "addSmartHomeTaskComment"),
                    ))?;
                let boa_return_value = function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
...
struct Device {
    ...
    status: Box<String>,
    room: Box<String>,
    createdBy: Box<candid::Principal>,
}
#[derive(
    serde::Deserialize,
    Debug,
...
struct SmartHomeTask {
    id: Box<String>,
    title: Box<String>,
    description: Box<String>,
    createdDate: Box<u64>,
    updatedDate: Box<Option<u64>>,
    dueDate: Box<String>,
    assignedTo: Box<String>,
    tags: Box<Vec<String>>,
    status: Box<String>,
    priority: Box<String>,
    comments: Box<Vec<String>>,
    devices: Box<Vec<Device>>,
}
#[derive(
    serde::Deserialize,
    Debug,
